	...
	$dl->printBox('<h1>'.$dl->getLocalizedString("linkAccount").'</h1>
				<form action="" method="post">
					<div class="form-group">
						<input required type="text" class="form-control" id="changeUsernameUserName" name="userhere" value="'.$_POST["userhere"].'" placeholder="'.$dl->getLocalizedString("linkAccountLocalUserNameFieldPlaceholder").'"><br>
						<input required type="password" class="form-control" id="changeUsernameNewUserName" name="passhere" value="'.$_POST["passhere"].'" placeholder="'.$dl->getLocalizedString("linkAccountLocalPasswordFieldPlaceholder").'"><br>
						<input required type="text" class="form-control" id="changeUsernamePassword" name="usertarg" value="'.$_POST["usertarg"].'" placeholder="'.$dl->getLocalizedString("linkAccountTargetUserNamePlaceholder").'"><br>
						<input required type="password" class="form-control" id="changeUsernameNewUserName" name="passtarg" value="'.$_POST["passtarg"].'" placeholder="'.$dl->getLocalizedString("linkAccountTargetPasswordFieldPlaceholder").'"><br>
						<input required pattern="https?://.+" type="text" class="form-control" id="changeUsernamePassword" name="server" value="http://www.boomlings.com/database/accounts/loginGJAccount.php" placeholder="'.$dl->getLocalizedString("linkAccountTargetURLFieldPlaceholder").'">
					</div>
