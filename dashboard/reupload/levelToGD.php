	...
	$dl->printBox('<h1>'.$dl->getLocalizedString("levelToGD").'</h1>
				<form action="" method="post">
					<div class="form-group">
						<input required type="text" class="form-control" id="userhere" name="userhere" placeholder="'.$dl->getLocalizedString("levelToGDUserFieldPlaceholder").'"><br>
						<input required type="password" class="form-control" id="passhere" name="passhere" placeholder="'.$dl->getLocalizedString("levelToGDPassFieldPlaceholder").'"><br>
						<input autofocus required type="number" min="1" class="form-control" id="levelID" name="levelID" placeholder="'.$dl->getLocalizedString("levelToGDlevelIDFieldPlaceholder").'"><br>
						<input required type="text" class="form-control" id="usertarg" name="usertarg" placeholder="'.$dl->getLocalizedString("levelToGDUserTargFieldPlaceholder").'"><br>
						<input required type="password" class="form-control" id="passtarg" name="passtarg" placeholder="'.$dl->getLocalizedString("levelToGDPassTargFieldPlaceholder").'"><br>
						<input required type="text" pattern="https?://.+" class="form-control" id="server" name="server" value="http://www.boomlings.com/database/" placeholder="'.$dl->getLocalizedString("levelToGDServerFieldPlaceholder").'"><br>
					</div>
