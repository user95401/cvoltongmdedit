...
{exit ('<div '.$styleForErrorAlert.'>Adding new data disabled by the administrator!</div>');}
	...
	public function ownCheck($commandInPerms, $accountID, $targetExtIDlvl){
		if( (($this->checkPermission($accountID, "command".$commandInPerms."All") OR ($targetExtIDlvl == $accountID AND $this->checkPermission($accountID, "command".$commandInPerms."Own")))) ){
			return true;
		}
		return false;
	}
