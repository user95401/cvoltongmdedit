...
/*user666 was here*/
ALTER TABLE `accounts` ADD `ip` TEXT NULL DEFAULT NULL AFTER `isActive`;
ALTER TABLE `accounts` ADD `isBanned` INT(1) NOT NULL DEFAULT '0' AFTER `isAdmin`;

ALTER TABLE `roles` ADD `AdminTools` INT NOT NULL DEFAULT '0' AFTER `dashboardModTools`;
ALTER TABLE `roles` ADD `seeLogs` INT NOT NULL DEFAULT '0' AFTER `dashboardModTools`;

ALTER TABLE `levels` CHANGE `downloads` `downloads` INT(11) NOT NULL DEFAULT '0';
ALTER TABLE `levels` CHANGE `likes` `likes` INT(11) NOT NULL DEFAULT '0';

CREATE TABLE `logs` (
  `id` int(11) NOT NULL,
  `userName` text NOT NULL,
  `action` longtext NOT NULL,
  `inTool` text NOT NULL,
  `time` time NOT NULL,
  `ip` text NOT NULL
